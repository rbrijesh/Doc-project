...
//   // decimals='2' use like this in input box for upto how many decimals
  //   // negative='1' use like this in input box for negative value
  ...
  //     this.run(parseFloat(this.el.nativeElement.value));
  //   }
